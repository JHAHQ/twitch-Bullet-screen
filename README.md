...
- **多語系支援**：內建繁體中文、英文、日文等10種語言切換功能。
- **效能提升**：優化過濾器邏輯，減少高流量聊天室時的記憶體佔用。

### 🚀 如何使用
1. 前往 [Releases](https://github.com/JHAHQ/twitch-Bullet-screen/releases) 下載 `Twitch彈幕控制台.exe`。
...
- **Multilingual support:** Built-in switching function for 10 languages ​​including Traditional Chinese, English, and Japanese.
